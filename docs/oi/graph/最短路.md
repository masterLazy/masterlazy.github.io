...
:::info
Dijkstra 有几种常见的实现，它们的时间复杂度各不相同。具体可以参考 [最短路 - OI Wiki # 时间复杂度](https://oi-wiki.org/graph/shortest-path/#%E6%97%B6%E9%97%B4%E5%A4%8D%E6%9D%82%E5%BA%A6)。下面给出的是上文写法的时间复杂度。
:::
